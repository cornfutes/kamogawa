...
- [x] demo: use in memory data for all API data requests for test user.
...
- [x] load test
  - [x] perform load test 
  - [x] consider having fake static website, cant login / not dynamic, in case of HN hug of death
  - [x] then host the real app on app.$DOMAIN_NAME.com or something
- [ ] logs and monitoring 
